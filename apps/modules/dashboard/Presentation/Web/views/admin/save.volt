        ...
        <div class="row">
            ...
            <div class="col-md-3" style="text-align: left;" > 
                <div class="card card-primary">
                  ...
                  <!-- /.card-header -->
                  <div class="card-body">
       <strong>Aksi         :</strong>{{jahitan['aksi']}}<br>
       <strong>Size     	  :</strong>{{jahitan['size']}}<br>
       <strong>Atas Nama    :</strong>{{jahitan['atasnama']}}<br>
       <strong>Alamat Kirim :</strong>{{jahitan['alamatkirim']}}<br>
       <strong>Keterangan   :</strong>{{jahitan['keterangan']}}<br>
       <strong>Pesan Admin   :</strong>{{jahitan['progres']}}<br>
