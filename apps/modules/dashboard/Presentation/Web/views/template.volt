    ...
    <div class="container">
      ...
      <nav id="nav-menu-container">
        ...
        <ul class="nav-menu">
          ...
          <li><a href="/dashboard/homeadmin">STICHU</a></li>
          ...
          <li><a href="/dashboard/admin">ListOrder</a></li>
          <li><a href="/dashboard/progressorder">ProgressOrder</a></li>
        
          <li><a style="margin-left: 550px" href="/dashboard/auth/logout" class="nav-link">Logout</a></li>
          {% endif%}
      ...
      <div class="container">
        <div class="row">
          ...
          {% if session.get('user-name') == null %}
           ...
           {% else %}
              <li class="list-inline-item">
                <a href="/dashboard/admin">ListOrder</a>
              </li>

              <li class="list-inline-item">
                <a href="/dashboard/progressorder">ListProgress</a>
              </li>
