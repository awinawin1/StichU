...
<a img src="../dist/img/grateful_people-wallpaper-1920x1080(12).jpg">
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b> StichU</b></a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <p class="mb-0">
        <a href="/dashboard/auth/register" class="text-center">Register</a>
      </p>
    </div>
    <!-- /.login-card-body -->
  </div>
